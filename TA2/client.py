...
class GUI(Tk):
    def __init__(self):
        ...
        # Create a label named page_label using Label() function and pass it text, font and bg parameter
        ...
        # Create and input box using Entry() method and pass it font, fg and bg parameter
